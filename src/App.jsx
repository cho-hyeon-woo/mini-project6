...
export default function App() {
  const dbAddress = "http://user94-ALB-1616828866.ap-southeast-1.elb.amazonaws.com:8080/books";
  ...
  const fetchBooks = async () => {
    try {
      ...
      if (data.length > 0) {
        ...
        try {
          const recRes = await fetch("http://user94-ALB-1616828866.ap-southeast-1.elb.amazonaws.com:8080/stars/recommend");
  ...
  const handleUpdateAccount = async () => {
    try {
      const res = await fetch(`http://user94-ALB-1616828866.ap-southeast-1.elb.amazonaws.com:8080/users/${currentUser.userId}`, {
        method: "PATCH",
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      const res = await fetch(`http://user94-ALB-1616828866.ap-southeast-1.elb.amazonaws.com:8080/users/${currentUser.userId}`, { method: "DELETE" });
